...
- `context/`: internal project context documents for scope, architecture, current state, and append-only progress history.
...
- `context/PROJECT.md`: product scope and command policy.
- `context/ARCHITECTURE.md`: this codebase map.
- `context/STATE.md`: current work state and next steps.
- `context/PROGRESS.md`: append-only progress log.
